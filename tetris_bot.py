...
def decide_and_place(block, board):
    ...
    Blocks have the following attributes:
     ...
     - array: a mxn array where 1's represent space the block occupies and 0's represent empty space
...
def main():
    ...
    while is_active:
        current_block, next_blocks = detector.get_next_blocks(not has_started)
